      ...
      >
        ...
        {currentState === "Sign Up" && (
          <input
            ...
            value={name}
            type="text"
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-800 outline-none transition bg-white text-gray-900"
        ...
        {/* Google Login Button */}
        <a
          href="https://amitkaoi.onrender.com/api/user/google"
